...
# Generated by scripts/gen_signals.py python_dicts.
SIGNALS_BY_MACHINE_NAME = types.MappingProxyType(
    {
        **dict.fromkeys(
            (
                "aarch64",
