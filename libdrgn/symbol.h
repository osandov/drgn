 ...
 * (in which case the lifetimes of each symbol name should be static).
 */
struct drgn_error *
...
/**
 * For destroying a builder on error conditions
 */
void
 ...
 * On error, the builder is deinitialized and need not be cleaned up.
 */
struct drgn_error *
