...
class Program:
    ...
    @overload
    def extra_module(
        self, name: Path, id: IntegerLike, *, create: Literal[False] = False
    ) -> ExtraModule:
        """
    ...
    @overload
    def extra_module(
        self, name: Path, id: IntegerLike, *, create: Literal[True]
...
class Module:
    ...
    * .. _module-supplementary-debug-file:
    ...
    not known yet or the module is not loaded in memory, then this is ``None``.
