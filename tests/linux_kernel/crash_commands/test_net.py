...
class TestNet(CrashCommandTestCase):
    def test_net(self):
        ...
        self.assertIn("for_each_netdev(prog)", cmd.drgn_option.stdout)
        self.assertIn("rows", cmd.drgn_option.globals)
    ...
    def test_net_arp(self):
        ...
        self.assertIn("neigh_table_for_each_neighbor(nht)", cmd.drgn_option.stdout)
        self.assertIn("rows", cmd.drgn_option.globals)
