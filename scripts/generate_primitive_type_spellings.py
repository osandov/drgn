...
SPELLINGS = [
    ...
    ('DRGN_C_TYPE_LONG_LONG', ['long long', 'signed long long', 'long long int', 'signed long long int']),
    ('DRGN_C_TYPE_UNSIGNED_LONG_LONG', ['unsigned long long', 'unsigned long long int']),
