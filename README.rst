...
* Fedora, RHEL/CentOS Stream >= 9
  ...
  .. code-block:: console
      ...
      $ sudo dnf install autoconf automake check-devel elfutils-debuginfod-client-devel elfutils-devel gcc git json-c-devel libkdumpfile-devel libtool make pcre2-devel pkgconf python3 python3-capstone python3-devel python3-pip python3-setuptools xz-devel

* RHEL/CentOS < 9, Oracle Linux

  .. code-block:: console

      $ sudo dnf install autoconf automake check-devel elfutils-devel gcc git json-c-devel libtool make pcre2-devel pkgconf python3 python3-capstone python3-devel python3-pip python3-setuptools xz-devel
...
* Debian/Ubuntu
  ...
  .. code-block:: console
      ...
      $ sudo apt install autoconf automake check gcc git libdebuginfod-dev libjson-c-dev libkdumpfile-dev liblzma-dev libelf-dev libdw-dev libpcre2-dev libtool make pkgconf python3 python3-capstone python3-dev python3-pip python3-setuptools zlib1g-dev
...
* Arch Linux
  ...
  .. code-block:: console
      ...
      $ sudo pacman -S --needed autoconf automake check gcc git json-c libelf libkdumpfile libtool make pcre2 pkgconf python python-capstone python-pip python-setuptools xz

* Gentoo

  .. code-block:: console

      $ grep -qxF 'dev-libs/capstone python' /etc/portage/package.use/capstone 2> /dev/null || echo 'dev-libs/capstone python' | sudo tee -a /etc/portage/package.use/capstone > /dev/null
      $ sudo emerge --noreplace --oneshot dev-build/autoconf dev-build/automake dev-libs/capstone dev-libs/check dev-libs/elfutils dev-libs/json-c dev-libs/libpcre2 sys-devel/gcc dev-vcs/git dev-libs/libkdumpfile dev-build/libtool dev-build/make dev-python/pip virtual/pkgconfig dev-lang/python dev-python/setuptools app-arch/xz-utils

* openSUSE

  .. code-block:: console

      $ sudo zypper install autoconf automake check-devel gcc git libdebuginfod-devel libdw-devel libelf-devel libjson-c-devel libkdumpfile-devel libtool make pcre2-devel pkgconf python3 python3-capstone python3-devel python3-pip python3-setuptools xz-devel
